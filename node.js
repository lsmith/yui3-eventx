...
Y.publish({
    ...
    domSubscribe: function (host, sub) {
        var args    = sub.payload || [],
            ...
            nodes = (thisObj instanceof Y.NodeList) ? thisObj : Y.all(thisObj);
...
YEventDOM._eventProto = proto(EventTarget.eventProto, {
    _getter: {
    ...
    get: function (attr) {
        var val = (this._getter[attr]) ?
                    this._getter[attr].call(this, attr) :
                    this._data[attr];
...
Y.mix(Node.prototype, {
    on: function () {
        ...
        args.splice(1, 0, this._node);
        YEventDOM._events._subscribe(args);
...
Y.mix(Y.NodeList.prototype, {
    ...
    detach: function (type, callback) {
        YEventDOM.detach(this._nodes, type, callback);
    ...
    if (thisObj) {
        if (isString(thisObj)) {
            ...
            return (thisObj.nodeType ||
                    thisObj instanceof Y.Node ||
                    thisObj instanceof Y.NodeList);
        }
    }
...
YUI.add('node', function(Y){}, '@VERSION@' ,{requires:['dom', 'eventx-core', 'eventx-dom', 'event-delegate', 'pluginhost'], skinnable:false, use:['node-base', 'node-style', 'node-screen', 'node-pluginhost', 'node-event-delegate', 'eventx-node']});
